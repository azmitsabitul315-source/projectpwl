    ...
    <div class="kl-layout">
        ...
        <aside class="kl-sidebar">
            ...
            <nav class="kl-sidebar-nav">
                ...
                <a href="<?= base_url('kategori') ?>" class="active"> Kategori</a>
        ...
        <main class="kl-main" style="background: var(--kl-bg); position: relative;">
            ...
            <div class="kl-main-content" style="max-width: 600px;">
                ...
                <div class="kl-page-header">
                    ...
                    <p>Buat kategori baru untuk kuliner.</p>
                </div>
                ...
                <div class="kl-card" style="padding: 32px;">
                    <form action="<?= base_url('kategori/store') ?>" method="post">
                        ...
                        <div class="kl-form-group">
                            <label class="kl-form-label">Nama Kategori <span class="kl-required">*</span></label>
                            <input type="text" name="nama" class="kl-input" placeholder="Contoh: Coffee Shop" required value="<?= old('nama') ?>">
                        </div>
                        <div class="kl-flex kl-gap-sm" style="margin-top: 24px;">
                            <button type="submit" class="kl-btn kl-btn-primary">
                                💾 Simpan
                            </button>
                            <a href="<?= base_url('kategori') ?>" class="kl-btn kl-btn-outline">
                                Batal
                            </a>
                        </div>
                    </form>
